...
class Model_OBJ
{
  public: 
	...
	void Model_OBJ::drawObject();
	void Model_OBJ::Zoom(float zoomX, float zoomY, float zoomZ);
	void Model_OBJ::Position(float posX, float posY, float posZ);
	void Model_OBJ::Rotation(float rotX, float rotY, float rotZ);
...
bool Model_OBJ::Load(char* filename)
{
	...
	if (objFile.is_open())													// If obj file is open, continue
	{
		...
		long fileSize = (long) objFile.tellg();									// get file size
